...
SOAP_DRAFT_MODEL = os.getenv("SOAP_DRAFT_MODEL", "gpt-5.2")
SOAP_FINAL_MODEL = os.getenv("SOAP_FINAL_MODEL", "gpt-5.2")
SOAP_SCRUB_MODEL = os.getenv("SOAP_SCRUB_MODEL", "gpt-5.2")
SOAP_REASONING_EFFORT = os.getenv("SOAP_REASONING_EFFORT", "high")
...
SOAP_SINGLE_PASS = os.getenv("SOAP_SINGLE_PASS", "0").strip() == "1"
SOAP_SINGLE_PASS_MODEL = os.getenv("SOAP_SINGLE_PASS_MODEL", SOAP_FINAL_MODEL)
SOAP_SINGLE_PASS_FALLBACK_MODEL = os.getenv("SOAP_SINGLE_PASS_FALLBACK_MODEL", SOAP_FINAL_MODEL)
SOAP_SINGLE_PASS_EFFORT = os.getenv("SOAP_SINGLE_PASS_EFFORT", "high")
SOAP_SINGLE_PASS_VERBOSITY = os.getenv("SOAP_SINGLE_PASS_VERBOSITY", "high")
