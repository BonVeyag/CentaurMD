...
SOAP_DRAFT_MODEL = os.getenv("SOAP_DRAFT_MODEL", "gpt-5-nano")
SOAP_FINAL_MODEL = os.getenv("SOAP_FINAL_MODEL", "gpt-5-nano")
...
SOAP_SINGLE_PASS_MODEL = os.getenv("SOAP_SINGLE_PASS_MODEL", "gpt-5-nano")
SOAP_SINGLE_PASS_FALLBACK_MODEL = os.getenv("SOAP_SINGLE_PASS_FALLBACK_MODEL", "gpt-5-nano")
